<?php
use AdventOfCode\Device\InventoryManagementSystem;
...
$inputs = file('./day2.input');
$ims = new InventoryManagementSystem($inputs);

echo 'What is the checksum for your list of box IDs? ' . $ims->getChecksum();

echo "\n\n";

echo 'What letters are common between the two correct box IDs? ' . $ims->getCommonLetters();
